...
public class DebugFive1 {
   public static void main(String args[]) {
      ...
      usersChoice = kb.nextInt();
      if (usersChoice == 1)  // Use == for comparison instead of = (assignment)
         bill = bill + LOW_PRICE;
