...
public class DebugSeven4
{
   public static void main(String[] args)
   {
      ...
      for(int i = 0; i < stringLength; i++) // out of bounds <=
      {
         char ch = Character.toLowerCase(aString.charAt(i)); // took me a long time to understand this TTTTTT
         System.out.print(ch);
         if(Character.isLetter(ch)) // removed the ! bc its a NOT smthn
         numLetters++;
      ...
      System.out.println("The number of LETTERS is " + numLetters); // concatenation
   }
}