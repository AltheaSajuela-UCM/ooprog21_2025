...
public class DebugSeven3
{
   ...
   { 
      ...
      quote = kb.nextLine(); // missing kb 
      System.out.print("Enter a character to search for >> ");
      charString = kb.nextLine(); // not int bc its a string
      searchChar = charString.charAt(0);
      System.out.println("indexOf('" + searchChar + "') is: " +
         quote.indexOf(searchChar)); // parenthesis 
      System.out.println("indexOf('a') is: " + quote.indexOf('a')); // parenthesis
